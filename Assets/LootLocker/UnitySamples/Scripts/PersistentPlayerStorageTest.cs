...
namespace LootLocker.Example
{
    ...
    {
        [Header("Save Data")]
        public List<LootLockerPayload> dataToSave;
        [Header("Delete Data")]
        ...
        private void OnGUI()
        {
            ...
            if (GUILayout.Button("New Data", GUILayout.ExpandWidth(true)))
                dataToSave.Add(new LootLockerPayload { key = "", value = "1", order = 1 });
            ...
            List<LootLockerPayload> dataToDelete = new List<LootLockerPayload>();
