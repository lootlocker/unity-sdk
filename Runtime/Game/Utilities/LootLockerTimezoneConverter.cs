...
{
    public static class LootLockerTimezoneConverter
    {
        public static readonly Dictionary<string, string> WindowsToIana = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
        ...
        public static readonly Dictionary<string, string> IanaToWindows = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
        ...
        public static string ConvertWindowsToIanaTzString(string windowsTimezone)
        {
            ...
            {
                // Return default IANA timezone if null
                return "Etc/UTC";
            }

            if (WindowsToIana.TryGetValue(windowsTimezone, out string iana))
                return iana;

            // Return default IANA timezone if not found
            return "Etc/UTC";
        }
        ...
        public static string ConvertIANAToWindowsTzString(string ianaTimezone)
        {
            ...
            if (ianaToWindows.TryGetValue(ianaTimezone, out string windows))
            {
                return windows;
            }
            // Return default Windows timezone if not found
            return "UTC";
        }
