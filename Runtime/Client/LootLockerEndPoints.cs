...
namespace LootLocker
{
    ...
    public class LootLockerEndPoints : RuntimeProjectSettings<LootLockerEndPoints>
    {
        ...
        public EndPointClass createCharacter = new EndPointClass("v1/player/character", LootLockerHTTPMethod.POST);
        public EndPointClass listCharacterTypes = new EndPointClass("v1/player/character/types", LootLockerHTTPMethod.GET);
